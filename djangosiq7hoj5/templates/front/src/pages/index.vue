	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0 7%","borderColor":"#eee","alignItems":"center","color":"#fff","textAlign":"right","display":"flex","justifyContent":"flex-end","overflow":"hidden","top":"0","borderRadius":"0","left":"0","background":"#111","borderWidth":"0px","width":"100%","fontSize":"14px","lineHeight":"32px","position":"relative","borderStyle":"solid","height":"32px","zIndex":"1002"}'>
			...
			<div :style='{"margin":"0","left":"7%","display":"inline-block","width":"auto","position":"absolute","float":"left","height":"32px"}'>
			  <span :style='{"padding":"0px","color":"inherit","alignItems":"center","display":"flex","width":"100%","lineHeight":"1.5","fontSize":"18px","float":"left","fontWeight":"600","height":"32px"}'>基于网络爬虫的考研信息共享平台的设计与实现</span>
			</div>
			<!-- weather -->
			<div class="weather" :style='{"padding":"0 20px","alignItems":"center","float":"left","justifyContent":"center","display":"none"}'>
			...
			<!-- time -->
			<div :style='{"padding":"0 4px","fontSize":"inherit","lineHeight":"24px","color":"inherit","display":"none"}'>{{times}}</div>
			...
			<div id="search" class="search" :style='{"padding":"0","margin":"0","alignItems":"center","flexWrap":"wrap","background":"none","display":"none","float":"left","height":"auto"}'>
				...
				<div :style='{"padding":"0","margin":"0","background":"none","display":"inline-block"}' class="input" v-if="queryIndex==0">
					<el-input v-model="yuanxiaoxinxischoolname" placeholder="学校名称"></el-input>
				</div>
				<div :style='{"padding":"0","margin":"0","borderRadius":"0 20px 20px 0","background":"none","display":"inline-blockinline-block"}' class="btn" v-if="queryIndex==0">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px 0 10px","margin":"0","color":"#333","borderRadius":"0 20px 20px 0","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="search('yuanxiaoxinxi')">
        ...
        <el-dialog title="报考咨询" :visible.sync="chatFormVisible" width="600px" :before-close="chatClose">
...
export default {
    data() {
		...
		queryIndex: 0,
		yuanxiaoxinxischoolname: '',
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-pay","buttons":["新增","查看","修改","删除"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-qrcode","buttons":["新增","查看","修改","删除"],"menu":"资料类型","menuJump":"列表","tableName":"ziliaoleixing"}],"menu":"资料类型管理"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论"],"appFrontIcon":"cuIcon-attentionfavor","buttons":["新增","查看","修改","删除","查看评论"],"menu":"考研资料","menuJump":"列表","tableName":"kaoyanziliao"}],"menu":"考研资料管理"},{"child":[{"allButtons":["新增","查看","修改","删除","学校总分统计","学校名称","分类","专业名称","专业类型统计","查看评论","首页总数","首页统计","爬取数据"],"appFrontIcon":"cuIcon-pic","buttons":["新增","查看","修改","删除","学校类型","硕士类型统计","爬取数据","查看评论"],"menu":"院校信息","menuJump":"列表","tableName":"yuanxiaoxinxi"}],"menu":"院校信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-group","buttons":["修改","删除","查看"],"menu":"考研论坛","tableName":"forum"}],"menu":"考研论坛"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-service","buttons":["查看","修改","删除"],"menu":"报考咨询","tableName":"chat"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-qrcode","buttons":["查看","修改"],"menu":"系统简介","tableName":"systemintro"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-medal","buttons":["新增","查看","修改","删除"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"考研资讯","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"考研资讯分类","tableName":"newstype"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论"],"appFrontIcon":"cuIcon-cardboard","buttons":["查看","查看评论"],"menu":"考研资料列表","menuJump":"列表","tableName":"kaoyanziliao"}],"menu":"考研资料模块"},{"child":[{"allButtons":["新增","查看","修改","删除","学校总分统计","学校名称","分类","专业名称","专业类型统计","查看评论","首页总数","首页统计","爬取数据"],"appFrontIcon":"cuIcon-goodsnew","buttons":["查看","查看评论"],"menu":"院校信息","menuJump":"列表","tableName":"yuanxiaoxinxi"}],"menu":"院校信息模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论"],"appFrontIcon":"cuIcon-cardboard","buttons":["查看","查看评论"],"menu":"考研资料列表","menuJump":"列表","tableName":"kaoyanziliao"}],"menu":"考研资料模块"},{"child":[{"allButtons":["新增","查看","修改","删除","学校总分统计","学校名称","分类","专业名称","专业类型统计","查看评论","首页总数","首页统计","爬取数据"],"appFrontIcon":"cuIcon-goodsnew","buttons":["查看","查看评论"],"menu":"院校信息","menuJump":"列表","tableName":"yuanxiaoxinxi"}],"menu":"院校信息模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
    ...
    methods: {
      search(tablename) {
        if (this.queryIndex == 0 && this.yuanxiaoxinxischoolname) {
          this.$router.push({path: '/index/' + tablename, query: {indexQueryCondition: this.yuanxiaoxinxischoolname}});
        }
      },
		// 获取当前时间
		setTimes() {

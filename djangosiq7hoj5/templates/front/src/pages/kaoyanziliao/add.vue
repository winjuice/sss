...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="资料名称" prop="ziliaomingcheng">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="资料简介" prop="ziliaojianjie">
            <el-input v-model="ruleForm.ziliaojianjie" 
                placeholder="资料简介" clearable :disabled=" false  ||ro.ziliaojianjie"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="资料附件" prop="ziliaofujian">
            <file-upload
            tip="点击上传资料附件"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="资料介绍" prop="ziliaojieshao">
            <editor 

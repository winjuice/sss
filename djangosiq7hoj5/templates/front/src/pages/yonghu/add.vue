...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="志愿学校" prop="zhiyuanxuexiao">
            <el-input v-model="ruleForm.zhiyuanxuexiao" 
                placeholder="志愿学校" clearable :disabled=" false  ||ro.zhiyuanxuexiao"></el-input>
          </el-form-item>
  ...
  export default {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='zhiyuanxuexiao'){
              this.ruleForm.zhiyuanxuexiao = obj[o];
              this.ro.zhiyuanxuexiao = true;
              continue;
            }
          }
        }else if(type=='edit'){
    ...
    // 多级联动参数
      ...
      onSubmit() {
			...
			if((this.ruleForm.yonghuzhanghao).toString().length<3){
                this.$message.error('用户账号长度不能小于3');
                return
			}
			if((this.ruleForm.yonghuzhanghao).toString().length>13){

<template>
	<div class="content" :style='{"alignContent":"flex-start","minHeight":"100vh","overflow":"hidden","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/a8c4412078c84883902ad3bedef73407.jpg) no-repeat center top / 100% 100%","display":"flex","width":"100%","position":"relative","height":"100vh"}'>
		...
		<div :style='{"width":"100%","padding":"20px 20px 0","display":"flex","height":"calc(100vh - 95px)"}'>
			<div :style='{"width":"25%","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"24px"}'>
						<div :style='{"color":"#fff","fontSize":"16px"}'>
							学校总分统计
						</div>
					</div>
					<div :style='{"width":"100%","height":"calc(100% - 24px)"}'>
						<div id="yuanxiaoxinxiChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"24px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 24px)"}'>
						<div id="yuanxiaoxinxiChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"24px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 24px)"}'>
						<div id="yuanxiaoxinxiChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"50%","padding":"0 20px","flexWrap":"wrap","justifyContent":"space-between","display":"flex"}'>
				<div v-if="systemIntroductionDetail" :style='{"padding":"20px","margin":"0 0 20px","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/26d4501d35db46278b1d99be2f14602f.png) no-repeat center top / 100% 100%","display":"flex","width":"calc(50% - 20px)","height":"calc(40% - 20px)"}'>
					<el-carousel :style='{"width":"50%","margin":"0 auto"}' trigger="click" indicator-position="inside" arrow="always" type="default" direction="horizontal" height="100%" :autoplay="true" :interval="3000" :loop="true">
				...
				<!-- 统计 -->
				<div :style='{"alignContent":"center","padding":"20px 20px","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/26d4501d35db46278b1d99be2f14602f.png) no-repeat center top / 100% 100%","display":"flex","width":"calc(50% - 20px)","fontSize":"14px","height":"calc(40% - 20px)","order":"2"}'>
					...
					<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,0)","justifyContent":"center","display":"flex"}'>
						...
						<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>院校信息总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{yuanxiaoxinxiCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="yuanxiaoxinxiChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"25%","flexWrap":"wrap","display":"flex"}'>
				<div class="tables">
					<div :style='{"margin":"0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,0)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px"}'>院校信息(总分TOP10)</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#5c89e6","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						<el-table-column :resizable="true" :sortable="false" prop="year" label="年份"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="specialname" label="专业名称"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="specialcode" label="专业编码"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="ranking" label="排名"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="total" label="总分"/>
						</el-table-column>
					</el-table>
				</div>
				<div class="echarts5">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"30px"}'>
						<div :style='{"color":"#fff","fontSize":"16px"}'>
							专业类型统计
						</div>
					</div>
					<div :style='{"width":"100%","height":"calc(100% - 30px)"}'>
						<div id="yuanxiaoxinxiChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
export default {
  ...
  created() {
    this.$nextTick(()=>{
		this.times()
		setTimeout(()=>{
			this.getyuanxiaoxinxiCount();
			this.yuanxiaoxinxiChat1();
			this.yuanxiaoxinxiChat2();
			this.yuanxiaoxinxiChat3();
			this.yuanxiaoxinxiChat4();
			this.yuanxiaoxinxiChat5();
		},500)
	})
  },
  methods:{
    ...
    getyuanxiaoxinxiCount() {
        this.$http({
            url: `yuanxiaoxinxi/count`,
            method: "get"
        }).then(({
            data
        }) => {
            if (data && data.code == 0) {
                this.yuanxiaoxinxiCount = data.data
            }
        })
    },
...
//统计接口1
    yuanxiaoxinxiChat1() {
      this.$nextTick(()=>{
        ...
        var yuanxiaoxinxiChart1 = echarts.init(document.getElementById("yuanxiaoxinxiChart1"),'carp');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                yuanxiaoxinxiChart1.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    yuanxiaoxinxiChart1.resize();
                },false);
            }
        });
      })
...
//统计接口2
    yuanxiaoxinxiChat2() {
      this.$nextTick(()=>{
        ...
        this.$http({
            url: "group/yuanxiaoxinxi/schoolname",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                var option = {};
                this.wordclouds(pArray,'yuanxiaoxinxiChart2');
...
//统计接口3
    yuanxiaoxinxiChat3() {
      this.$nextTick(()=>{
        ...
        var yuanxiaoxinxiChart3 = echarts.init(document.getElementById("yuanxiaoxinxiChart3"),'carp');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                yuanxiaoxinxiChart3.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    yuanxiaoxinxiChart3.resize();
                },false);
            }
        });
      })
...
//统计接口4
    yuanxiaoxinxiChat4() {
      this.$nextTick(()=>{
        ...
        var yuanxiaoxinxiChart4 = echarts.init(document.getElementById("yuanxiaoxinxiChart4"),'carp');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
				let titleObj = this.line5?this.line5.title:this.line.title
				titleObj.text = '专业名称'
                const legendObj = this.line5?this.line5.legend:this.line.legend
                legendObj.data = [
					'政治',
					'英语',
					'专业一',
				...
				let xAxisObj = this.line5?this.line5.xAxis:this.line.xAxis
				xAxisObj.type = 'category'
				xAxisObj.boundaryGap = false
				xAxisObj.data = xAxis1
				let yAxisObj = this.line5?this.line5.yAxis:this.line.yAxis
				yAxisObj.type = 'value'
				let seriesObj = [
                    {
                        data: yAxis1,
                ...
                for(let i=0;i<seriesObj.length;i++){
				      seriesObj[i] = Object.assign(seriesObj[i] , this.line5?this.line5.series:this.line.series)
                }
                ...
                option = {
					backgroundColor: this.line5?this.line5.backgroundColor:this.line.backgroundColor,
					color: this.line5?this.line5.color:this.line.color,
					title: titleObj,
					legend: legendObj,
                    tooltip: tooltipObj,
					grid: gridObj,
                ...
                // 使用刚指定的配置项和数据显示图表。
                yuanxiaoxinxiChart4.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    yuanxiaoxinxiChart4.resize();
				},false);
            }
        });
      })
...
//统计接口5
    yuanxiaoxinxiChat5() {
      this.$nextTick(()=>{
        ...
        var yuanxiaoxinxiChart5 = echarts.init(document.getElementById("yuanxiaoxinxiChart5"),'carp');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                yuanxiaoxinxiChart5.setOption(option);


                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    yuanxiaoxinxiChart5.resize();
					},false);
            }
        });
      })

...
class yonghu(BaseModel):
    ...
    zhiyuanxuexiao=models.CharField ( max_length=255, null=True, unique=False, verbose_name='志愿学校' )
    '''
...
class ziliaoleixing(BaseModel):
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    ziliaoleixing=models.CharField ( max_length=255, null=True,unique=True, verbose_name='资料类型' )
    '''
...
class kaoyanziliao(BaseModel):
    __doc__ = u'''kaoyanziliao'''
    __tablename__ = 'kaoyanziliao'
    ...
    ziliaojianjie=models.CharField ( max_length=255, null=True, unique=False, verbose_name='资料简介' )
    ziliaofujian=models.TextField   (  null=True, unique=False, verbose_name='资料附件' )
    ziliaojieshao=models.TextField   (  null=True, unique=False, verbose_name='资料介绍' )
    shangchuanshijian=models.DateField   (  null=True, unique=False, verbose_name='上传时间' )
    ...
    fengmian=Text
    ziliaoleixing=VARCHAR
    ziliaojianjie=VARCHAR
    ziliaofujian=Text
    ziliaojieshao=Text
    shangchuanshijian=Date
    thumbsupnum=Integer
    crazilynum=Integer
    discussnum=Integer
    storeupnum=Integer
    '''
    class Meta:
        db_table = 'kaoyanziliao'
        verbose_name = verbose_name_plural = '考研资料'
class yuanxiaoxinxi(BaseModel):
    __doc__ = u'''yuanxiaoxinxi'''
    __tablename__ = 'yuanxiaoxinxi'
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    year=models.IntegerField  (  null=True, unique=False, verbose_name='年份' )
    schoolname=models.CharField ( max_length=255, null=True, unique=False, verbose_name='学校名称' )
    specialname=models.CharField ( max_length=255, null=True, unique=False, verbose_name='专业名称' )
    specialcode=models.CharField ( max_length=255, null=True, unique=False, verbose_name='专业编码' )
    typename=models.CharField ( max_length=255, null=True, unique=False, verbose_name='分类' )
    typeschool=models.CharField ( max_length=255, null=True, unique=False, verbose_name='学校类型' )
    degreename=models.CharField ( max_length=255, null=True, unique=False, verbose_name='硕士类型' )
    ranking=models.IntegerField  (  null=True, unique=False, verbose_name='排名' )
    total=models.IntegerField  (  null=True, unique=False, verbose_name='总分' )
    politics=models.IntegerField  (  null=True, unique=False, verbose_name='政治' )
    english=models.IntegerField  (  null=True, unique=False, verbose_name='英语' )
    specialone=models.IntegerField  (  null=True, unique=False, verbose_name='专业课一' )
    specialtwo=models.IntegerField  (  null=True, unique=False, verbose_name='专业课二' )
    thumbsupnum=models.IntegerField  (  null=True, unique=False,default='0', verbose_name='赞' )
    crazilynum=models.IntegerField  (  null=True, unique=False,default='0', verbose_name='踩' )
    ...
    '''
    class Meta:
        db_table = 'yuanxiaoxinxi'
        verbose_name = verbose_name_plural = '院校信息'
class chat(BaseModel):
    ...
    class Meta:
        db_table = 'chat'
        verbose_name = verbose_name_plural = '报考咨询'
class forum(BaseModel):
    ...
    class Meta:
        db_table = 'forum'
        verbose_name = verbose_name_plural = '考研论坛'
class newstype(BaseModel):
    ...
    class Meta:
        db_table = 'newstype'
        verbose_name = verbose_name_plural = '考研资讯分类'
class news(BaseModel):
    ...
    class Meta:
        db_table = 'news'
        verbose_name = verbose_name_plural = '考研资讯'
...
class discusskaoyanziliao(BaseModel):
    __doc__ = u'''discusskaoyanziliao'''
    __tablename__ = 'discusskaoyanziliao'
    ...
    '''
    class Meta:
        db_table = 'discusskaoyanziliao'
        verbose_name = verbose_name_plural = '考研资料评论表'
class discussyuanxiaoxinxi(BaseModel):
    __doc__ = u'''discussyuanxiaoxinxi'''
    __tablename__ = 'discussyuanxiaoxinxi'
    ...
    '''
    class Meta:
        db_table = 'discussyuanxiaoxinxi'
        verbose_name = verbose_name_plural = 'yuanxiaoxinxi评论表'

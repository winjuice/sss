...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        # cmd = "cd /yykj/python/9999/spiderdo3uy2w0 && scrapy crawl "+tableName+"Spider -a databaseName=djangosiq7hoj5"
        # Windows
        cmd = "cd D:\\BYSJ\\spider && D:\\Python\\Python37\\Scripts\\scrapy.exe crawl " + tableName + "Spider -a databaseName=djangosiq7hoj5"
        os.system(cmd)
